...
using CrowdedPlace.MobileApi;
using CrowdedPlace.MobileApi.Extensions;
using CrowdedPlace.MobileApi.Implementations;
...
namespace crowded
{
    public class LocalizationTests
    {
        ...
        public void String_Localization_Test()
        {
           ...
           var actualValueRu = LocalizationExtension.GetString(stringLocalizer, targetLocaleRu, "NewPosterPush").Value;
           var actualValueEn = LocalizationExtension.GetString(stringLocalizer, targetLocaleEn, "NewPosterPush").Value;
