...
using CrowdedPlace.Libraries.Network.Interfaces;
using Newtonsoft.Json;

namespace CrowdedPlace.Libraries.Network.Implementations
{
    public class Network : INetwork
    {
        ...
        public async Task<(BaseResult baseResult, string response)> LoadFilePostAsync(string url, byte[] stream,
            string bearerToken)
        {
